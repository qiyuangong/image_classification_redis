...
//
//    val parser = new OptionParser[RedisPerfParams]("ResNet50 Int8 Performance Test") {
//      opt[String]('m', "model")
...
//    }
//
//    parser.parse(args, RedisPerfParams()).foreach { param =>
//      val batchSize = param.batchSize
//      val batchInput = Tensor(Array(1, batchSize, 224, 224, 3)).rand()
//      Engine.init
//
//
//
